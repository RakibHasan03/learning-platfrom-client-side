                ...
                <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-violet-500 dark:text-gray-100">
                    ...
                    <form onSubmit={submitHandler}  className="space-y-6 ng-untouched ng-pristine ng-valid">
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" name="remember" id="remember" aria-label="Remember me" className="mr-1 rounded-lg focus:ring-blue-800 focus:dark:border-blue-800 focus:ring-2 accent-blue-800" />
                            <label htmlFor="remember" className="text-sm text-white">Accept Terms And Conditions</label>
                        </div>
                        <button className="block w-full p-3 text-center rounded-sm dark:text-gray-900 bg-white hover:bg-violet-300">Register</button>
                    </form>
